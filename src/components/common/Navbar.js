 ...
 * Navbar
 * ------
 * Top-level navigation bar visible on every page.
 * Dynamically fetches catalog categories for the dropdown,
 * renders auth/cart actions, and highlights the current route.
 */
const Navbar = () => {
